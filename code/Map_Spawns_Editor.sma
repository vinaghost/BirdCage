...
public plugin_init()
{
	...
	register_clcmd("say /spawn", "editor_menu", REQUIRED_ADMIN_LEVEL, "- open editor menu")
	register_clcmd("amx_spawn", "editor_onoff", REQUIRED_ADMIN_LEVEL, "- 1/0 switch editor function on/off")
